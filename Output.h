...
public:
	...
	void PrintInteger(int integer, string PreviousMsg) const;   // Prints an integer on the Status bar                                     //Abdullah - Added This

	void PrintCell(CellPosition CellPos) const;  //Prints on the status bar the vCell and hCell of the clicked cell                        //Abdullah - Added This
	...
	bool HasLadder (const CellPosition & fromCellPos, const CellPosition & toCellPos) const;
